...
var uzAjaxFilter = {
    ...
    onFieldChange: function(isManualChange, forceEmptyVals){
        ...
        var searchSubCats = $("form[name=" + this.filterFormName + "] #flt_search_subcats:checked").length? 1: 0;
        ...
        //this.addToDebug("hRequest = "+this.toString(hRequest)+"<br>\n\n");
                    ...
                    switch(this.aFields[i].type){
                        ...
                        case "checkbox":
                            ...
                            if(this.aFields[i].formName.indexOf("[]") < 0){
                                ...
                                // Single checkbox
                                //console.log(name);console.log(this.oForm.elements);
                                ...
                                while(j <= this.aFields[i].flagsCnt){
                                    if($("form[name=" + this.filterFormName + "] #" + cName + j + ":checked").length) {
                                        res.push($("form[name=" + this.filterFormName + "] #" + cName + j + ":checked").val());
                                    }
                                    j++;
                                }
                            }
                        ...
                        case "select":
                            ...
                            break;
                        case "interval":
                            var res = [$("form[name=" + this.filterFormName + "] #"+this.aFields[i].name+"_from").val(), $("form[name=" + this.filterFormName + "] #"+this.aFields[i].name+"_to").val()];
                            break;
                        default:
    ...
    populateCheckbox: function(hData) {
        ...
        if(name.indexOf("[]") <= 0){
            ...
            $("form[name=" + this.filterFormName + "] #" + name).checked = !(defaultVal == '0');
        } else {
            ...
            while(i <= hProp.flagsCnt){
                if($("form[name=" + this.filterFormName + "] #" + cName).length){
                    val = $("form[name=" + this.filterFormName + "] #" + cName).val();
    ...
    populateRadio: function(hData) {
        ...
        i = 0;
        cName = "rd_"+name+"_"+i;
        while($("form[name=" + this.filterFormName + "] #" + cName).length){
            // TODO. Verify code
            oInput = $("form[name=" + this.filterFormName + "] #" + cName);
            val = oInput.val();
    ...
    initInterval: function(name, hData) {
        ...
        $("form[name=" + this.filterFormName + "] #"+name+this.intervalObjectIdPostfix).slider({
            ...
            slide: function( event, ui ) {
                ...
                $("form[name=" + uzAjaxFilter.filterFormName + "] #"+name+"_from").val(valFrom);
                $("form[name=" + uzAjaxFilter.filterFormName + "] #"+name+"_to").val(valTo);
            },
        ...
        */
        ...
        // Init inputs values
        //
        $("form[name=" + this.filterFormName + "] #"+name+"_from").val(valFrom);
        $("form[name=" + this.filterFormName + "] #"+name+"_to").val(valTo);
    },
    ...
    onFilterFieldIntervalChange: function(fName, forcedPostfix){
        ...
        var valFrom = $("form[name=" + this.filterFormName + "] #"+fName+"_from").val();
        var valTo = $("form[name=" + this.filterFormName + "] #"+fName+"_to").val();
        ...
        $("form[name=" + this.filterFormName + "] #"+fName+"_from").val(valFrom);
        $("form[name=" + this.filterFormName + "] #"+fName+"_to").val(valTo);
